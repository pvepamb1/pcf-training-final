...
<div>
    <div class="fligthside">
        <img src="../assests/img/plane.jpg" width="450px" height="450px" style="padding-left:150px; padding-top: 30px">
        <button onclick="window.location.href = '/flights';" class="button" style="vertical-align:middle; margin-left: 250px"><span>Book Flight </span></button>
    </div>
